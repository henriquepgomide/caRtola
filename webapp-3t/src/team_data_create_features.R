...
path_to_matches <- "https://raw.githubusercontent.com/henriquepgomide/caRtola/master/"

matches_18 <- read.csv(paste0(path_to_matches,"data/2018/2018_partidas.csv"),
                       stringsAsFactors = FALSE)
matches_18 <- process2018Matches(matches_18)

matches_19 <- read.csv(paste0(path_to_matches,"data/2019/2019_partidas.csv"),
                       stringsAsFactors = FALSE) 
matches_19 <- dplyr::mutate(matches_19, year = 2019)

matches_20 <- read.csv(paste0(path_to_matches,"data/2020/2020_partidas.csv"),
                       stringsAsFactors = FALSE) 
...
write.csv(df_to_export,
          sprintf("data/2020-team-features-round-%s.csv",
...
write.csv(df_rank_to_export,
          sprintf("data/2020-team-rankings-round-%s.csv", 
                  max(matches_to_predict$round)),
          row.names = FALSE,
          na = "0")
