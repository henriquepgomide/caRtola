...
treino <- cartola %>%
            filter(atletas.rodada_id < 10 & atletas.status_id == "Provável")

validacao <- cartola %>%
            filter(atletas.rodada_id == 10 & atletas.status_id == "Provável")

# Selecionar somente algumas variáveis
variaveis <- c("atletas.clube.id.full.name", "atletas.jogos_num", "casa", "atletas.posicao_id", "atletas.pontos_num", "atletas.media_num")
